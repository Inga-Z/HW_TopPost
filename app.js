...
<div class = "container">
    <div class = "row">
        <div class = "col-12 col-md-8">
            <input type="text" class="form-control" size="80" data-id="link" placeholder = "Введите текст или вставьте ссылку">
        </div>
        <div class = "col">
        ...
        <div class = "col">
            <button class="btn btn-primary" data-action="add">OK</button>
        </div>
    </div>
</div>
